...
require_relative "lib/abb/drive/version"

Gem::Specification.new do |s|
  s.name = "abb_drive"
  s.version = ABB::Drive::VERSION
  s.platform = Gem::Platform::RUBY
  s.authors = ["Cody Cutrer"]
  s.email = "cody@cutrer.us'"
  s.homepage = "https://github.com/ccutrer/ruby-abb_drive"
  s.summary = "Library for communication with ABB ACS Drives via ModBus"
  s.license = "MIT"
  s.metadata = {
